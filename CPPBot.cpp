...
void botSetup() {
	...
	bot1 = makeBot(user, pass,"213.179.209.168", 17200, vers, wn);
	bot2 = makeBot(user2, pass2,"213.179.209.168", 17200, vers, wn);
	bot3 = makeBot(user3, pass3,"213.179.209.168", 17200, vers, wn);
	while (true) {
		bot1.eventLoop();
		bot2.eventLoop();
		bot3.eventLoop();
